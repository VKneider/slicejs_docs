export default class TheSliceTeam extends HTMLElement {
   ...
   async init() {
      ...
      const Victor = {
         name: "Victor Kneider",
         role: "Founder. Lead Developer. Software Architect. (2022 - Present)",
      ...
      const Julio = {
         name: "Julio Graterol",
         role: "Frontend Developer. Visual Components Library Creator and Designer (2023 - 2024)",
         image: "https://avatars.githubusercontent.com/u/99130732?v=4",
         description: "Experienced Frontend Developer and Designer. He is the creator of the Visual Components Library and the designer of the Slice.js logo and website.",
         links: [
   ...
   renderSpecialThanks() {
      ...
      specialThanksContent.innerHTML = `
        ...
        <p>
          From Slice.js we would like to express our deepest gratitude to <strong><a href="https://www.linkedin.com/in/jubert-perez/"> Jubert Pérez</a></strong> 
